...
URL = 'https://ru.investing.com/equities/amazon-com-inc'
...
def get_content(html):
    ...
    a = item.find('h1', class_='text-2xl font-semibold instrument-header_title__GTWDv mobile:mb-2').get_text().replace('.',',')
